...
class ExchangeControllerTest {
    ...
    void testConvertCurrencySuccess() throws Exception {
        ...
        net.mycompany.commerce.purchase.application.exchange.dto.ExchangeRateResponseDto responseDto = net.mycompany.commerce.purchase.application.exchange.dto.ExchangeRateResponseDto.builder()
