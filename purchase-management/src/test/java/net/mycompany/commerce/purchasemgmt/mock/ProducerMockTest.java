package net.mycompany.commerce.purchasemgmt.mock;
...
class ProducerMockTest {
    ...
    void testEnqueuePurchase() throws Exception {
        ...
        Mockito.when(queueManager.enqueue(any(StorePurchaseRequestDto.class))).thenAnswer(invocation -> {
            ...
            net.mycompany.commerce.purchasemgmt.domain.model.PurchaseTransaction tx = Mockito.mock(net.mycompany.commerce.purchasemgmt.domain.model.PurchaseTransaction.class);
    ...
    static class PurchaseTransactionMock extends net.mycompany.commerce.purchasemgmt.domain.model.PurchaseTransaction {
        private final String transactionId;
        public PurchaseTransactionMock(String transactionId) { this.transactionId = transactionId; }
        @Override
        public net.mycompany.commerce.purchasemgmt.domain.valueobject.TransactionId getTransactionId() { return new net.mycompany.commerce.purchasemgmt.domain.valueobject.TransactionId(transactionId); }
    }
    ...
    class PurchaseTransactionAudit {
        ...
        private net.mycompany.commerce.purchasemgmt.domain.model.PurchaseTransaction purchaseTransaction;
        public String getOperation() { return operation; }
        public void setOperation(String op) { this.operation = op; }
        public net.mycompany.commerce.purchasemgmt.domain.model.PurchaseTransaction getPurchaseTransaction() { return purchaseTransaction; }
        public void setPurchaseTransaction(net.mycompany.commerce.purchasemgmt.domain.model.PurchaseTransaction tx) { this.purchaseTransaction = tx; }
    }
